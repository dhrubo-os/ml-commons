...
public class MLHttpClientFactory {
    ...
    public static SdkAsyncHttpClient getAsyncHttpClient(
        ...
        return buildHttpClient(connectionTimeout, readTimeout, readTimeout, maxConnections, connectorPrivateIpEnabled, skipSslVerification);
    }
    ...
    public static SdkAsyncHttpClient getAsyncHttpClient(ConnectorClientConfig config, boolean connectorPrivateIpEnabled) {
        ...
        Duration connectionAcquisitionTimeout = acquisitionTimeoutValue != null ? Duration.ofMillis(acquisitionTimeoutValue) : readTimeout;
