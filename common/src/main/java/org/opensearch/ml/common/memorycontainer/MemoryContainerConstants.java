...
public class MemoryContainerConstants {
    ...
    public static final String SEMANTIC_FACTS_EXTRACTION_PROMPT =
        """
            ...
            • Always include the subject's name (e.g., "Caroline attended..." not "Attended..."). Do NOT start with pronouns.
            • Include relative time references (e.g., "last Friday", "two weeks ago") when no absolute date is available — do not omit them.
    ...
    public static final String USER_PREFERENCE_FACTS_EXTRACTION_PROMPT =
        """
            ...
            • Implicit: infer from a single strong signal or repeated choices. Include identity statements ("I am a...", "I work as..."), emotional milestones, future plans, and self-care routines.
            </SCOPE>

            <EXTRACT>
            • Specific, actionable, likely long-term preferences, values, identity facts, and personal goals. Ignore trivial one-off statements.
            </EXTRACT>
